...
export const KEYBOARD_LAYOUTS: Record<KeyboardLayout, KeyConfig[][]> = {
  qwertz: [
    // Row 1
    [
      { key: '^', display: '^', displayShift: '°', finger: Finger.LeftPinky, row: 1 },
      { key: '1', display: '1', displayShift: '!', finger: Finger.LeftPinky, row: 1 },
      { key: '2', display: '2', displayShift: '"', displayAltGr: '²', finger: Finger.LeftRing, row: 1 },
      { key: '3', display: '3', displayShift: '§', displayAltGr: '³', finger: Finger.LeftMiddle, row: 1 },
      { key: '4', display: '4', displayShift: '$', finger: Finger.LeftIndex, row: 1 },
      { key: '5', display: '5', displayShift: '%', finger: Finger.LeftIndex, row: 1 },
      { key: '6', display: '6', displayShift: '&', finger: Finger.RightIndex, row: 1 },
      { key: '7', display: '7', displayShift: '/', displayAltGr: '{', finger: Finger.RightIndex, row: 1 },
      { key: '8', display: '8', displayShift: '(', displayAltGr: '[', finger: Finger.RightMiddle, row: 1 },
      { key: '9', display: '9', displayShift: ')', displayAltGr: ']', finger: Finger.RightRing, row: 1 },
      { key: '0', display: '0', displayShift: '=', displayAltGr: '}', finger: Finger.RightPinky, row: 1 },
      { key: 'ß', display: 'ß', displayShift: '?', displayAltGr: '\\', finger: Finger.RightPinky, row: 1 },
      { key: 'Backspace', display: '⌫', finger: Finger.RightPinky, width: 2, row: 1 },
    ],
    // Row 2
    [
      { key: 'Tab', display: 'Tab', finger: Finger.LeftPinky, width: 1.5, row: 2 },
      { key: 'q', display: 'q', displayShift: 'Q', displayAltGr: '@', finger: Finger.LeftPinky, row: 2 },
      { key: 'w', display: 'w', displayShift: 'W', finger: Finger.LeftRing, row: 2 },
      { key: 'e', display: 'e', displayShift: 'E', displayAltGr: '€', finger: Finger.LeftMiddle, row: 2 },
      { key: 'r', display: 'r', displayShift: 'R', finger: Finger.LeftIndex, row: 2 },
      { key: 't', display: 't', displayShift: 'T', finger: Finger.LeftIndex, row: 2 },
      { key: 'z', display: 'z', displayShift: 'Z', finger: Finger.RightIndex, row: 2 },
      { key: 'u', display: 'u', displayShift: 'U', finger: Finger.RightIndex, row: 2 },
      { key: 'i', display: 'i', displayShift: 'I', finger: Finger.RightMiddle, row: 2 },
      { key: 'o', display: 'o', displayShift: 'O', finger: Finger.RightRing, row: 2 },
      { key: 'p', display: 'p', displayShift: 'P', finger: Finger.RightPinky, row: 2 },
      { key: 'ü', display: 'ü', displayShift: 'Ü', finger: Finger.RightPinky, row: 2 },
      { key: '+', display: '+', displayShift: '*', finger: Finger.RightPinky, row: 2 },
    ],
    // Row 3
    [
      { key: 'CapsLock', display: 'Caps', finger: Finger.LeftPinky, width: 1.8, row: 3 },
      { key: 'a', display: 'a', displayShift: 'A', finger: Finger.LeftPinky, row: 3 },
      { key: 's', display: 's', displayShift: 'S', finger: Finger.LeftRing, row: 3 },
      { key: 'd', display: 'd', displayShift: 'D', finger: Finger.LeftMiddle, row: 3 },
      { key: 'f', display: 'f', displayShift: 'F', finger: Finger.LeftIndex, row: 3 },
      { key: 'g', display: 'g', displayShift: 'G', finger: Finger.LeftIndex, row: 3 },
      { key: 'h', display: 'h', displayShift: 'H', finger: Finger.RightIndex, row: 3 },
      { key: 'j', display: 'j', displayShift: 'J', finger: Finger.RightIndex, row: 3 },
      { key: 'k', display: 'k', displayShift: 'K', finger: Finger.RightMiddle, row: 3 },
      { key: 'l', display: 'l', displayShift: 'L', finger: Finger.RightRing, row: 3 },
      { key: 'ö', display: 'ö', displayShift: 'Ö', finger: Finger.RightPinky, row: 3 },
      { key: 'ä', display: 'ä', displayShift: 'Ä', finger: Finger.RightPinky, row: 3 },
      { key: '#', display: '#', displayShift: "'", finger: Finger.RightPinky, row: 3 },
      { key: 'Enter', display: '⏎', finger: Finger.RightPinky, width: 1.5, row: 3 },
    ],
    // Row 4
    [
      { key: 'Shift', display: '⇧', finger: Finger.LeftPinky, width: 2.3, row: 4 },
      { key: '<', display: '<', displayShift: '>', finger: Finger.LeftPinky, row: 4 },
      { key: 'y', display: 'y', displayShift: 'Y', finger: Finger.LeftPinky, row: 4 },
      { key: 'x', display: 'x', displayShift: 'X', finger: Finger.LeftRing, row: 4 },
      { key: 'c', display: 'c', displayShift: 'C', finger: Finger.LeftMiddle, row: 4 },
      { key: 'v', display: 'v', displayShift: 'V', finger: Finger.LeftIndex, row: 4 },
      { key: 'b', display: 'b', displayShift: 'B', finger: Finger.LeftIndex, row: 4 },
      { key: 'n', display: 'n', displayShift: 'N', finger: Finger.RightIndex, row: 4 },
      { key: 'm', display: 'm', displayShift: 'M', displayAltGr: 'µ', finger: Finger.RightIndex, row: 4 },
      { key: ',', display: ',', displayShift: ';', finger: Finger.RightMiddle, row: 4 },
      { key: '.', display: '.', displayShift: ':', finger: Finger.RightRing, row: 4 },
  ...
  qwerty: [
    ...
    [
      ...
      { key: '5', display: '5', displayShift: '%', finger: Finger.LeftIndex, row: 1 },
      { key: '6', display: '6', displayShift: '^', finger: Finger.RightIndex, row: 1 },
      { key: '7', display: '7', displayShift: '&', finger: Finger.RightIndex, row: 1 },
      { key: '8', display: '8', displayShift: '*', finger: Finger.RightMiddle, row: 1 },
      { key: '9', display: '9', displayShift: '(', finger: Finger.RightRing, row: 1 },
      { key: '0', display: '0', displayShift: ')', finger: Finger.RightPinky, row: 1 },
      { key: '-', display: '-', displayShift: '_', finger: Finger.RightPinky, row: 1 },
      { key: '=', display: '=', displayShift: '+', finger: Finger.RightPinky, row: 1 },
      { key: 'Backspace', display: '⌫', finger: Finger.RightPinky, width: 2, row: 1 },
    ],
    // Row 2
    [
      ...
      { key: 'r', display: 'r', displayShift: 'R', finger: Finger.LeftIndex, row: 2 },
      { key: 't', display: 't', displayShift: 'T', finger: Finger.LeftIndex, row: 2 },
      { key: 'y', display: 'y', displayShift: 'Y', finger: Finger.RightIndex, row: 2 },
      { key: 'u', display: 'u', displayShift: 'U', finger: Finger.RightIndex, row: 2 },
      { key: 'i', display: 'i', displayShift: 'I', finger: Finger.RightMiddle, row: 2 },
      { key: 'o', display: 'o', displayShift: 'O', finger: Finger.RightRing, row: 2 },
      { key: 'p', display: 'p', displayShift: 'P', finger: Finger.RightPinky, row: 2 },
    ...
    [
      { key: 'Shift', display: '⇧', finger: Finger.LeftPinky, width: 2.3, row: 4 },
      { key: 'z', display: 'z', displayShift: 'Z', finger: Finger.LeftPinky, row: 4 },
      { key: 'x', display: 'x', displayShift: 'X', finger: Finger.LeftRing, row: 4 },
      { key: 'c', display: 'c', displayShift: 'C', finger: Finger.LeftMiddle, row: 4 },
      { key: 'v', display: 'v', displayShift: 'V', finger: Finger.LeftIndex, row: 4 },
      { key: 'b', display: 'b', displayShift: 'B', finger: Finger.LeftIndex, row: 4 },
      ...
      { key: ',', display: ',', displayShift: '<', finger: Finger.RightMiddle, row: 4 },
      { key: '.', display: '.', displayShift: '>', finger: Finger.RightRing, row: 4 },
      { key: '/', display: '/', displayShift: '?', finger: Finger.RightPinky, row: 4 },
      { key: 'ShiftRight', display: '⇧', finger: Finger.RightPinky, width: 2.3, row: 4 },
    ],
    // Space Row
    [
